...
const ChooseAlarm = () => {
  ...
  const [alarmSelected, setAlarmSelected] = useState(alarm.value);
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-200">
      <View className="relative items-center my-5">
        <Text className="text-base text-gray-900 font-semibold">Sound</Text>

        <Pressable
          className="absolute right-0 px-5 z-10"
          onPress={() => {
            alarm.updateValue(alarmSelected);
            router.back();
          }}
        >
